<?php
  ...
  include('rough.php');
	...
	{	
		...
		$str = "SELECT * FROM ambulance_det WHERE email='$email' and password='$pass'";
		...
		else
		{
			...
			$_SESSION['id']=$row[0];
			$_SESSION['hosid']=$row[1];
			$_SESSION['name']=$row[2];
      $_SESSION['email']=$row[3];
      $_SESSION['address']=$row[5];
      $_SESSION['hosiname']=$row[6];
					...
					<div class="box box-border">
						<div class="box-body">
							<form method="post" action="login.php" enctype="multipart/form-data">
								...
								<div>
									<span>Don't have an account?</span> <a href="registeramb.php">Register here </a>
								</div>
							</form>
						</div>
					</div>
